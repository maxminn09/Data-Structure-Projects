...
public:
	...
	void remove(const T data);			//removing data by data											
	...
	//int count(const string cName);												//Commenting out the functions that are not required 
	//double calcAverage();															//Commenting out the functions that are not required 				
	...
	//Overloading the += operator													//Commenting out the functions that are not required 
	//void operator += (LinkedList& l);												//Commenting out the functions that are not required 			
...
//Commenting out the functions that are not required 	
